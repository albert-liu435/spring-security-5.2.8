...
/**
 * SessionRegistry的默认实现类，拥有存储SessionInformation，同时实现了ApplicationListener的接口拥有监听Session的销毁事件
...
public class SessionRegistryImpl implements SessionRegistry,
	...
	/**
	 * 根据sessionId删除SessionInformation
	 *
