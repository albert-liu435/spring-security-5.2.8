...
public abstract class AbstractRememberMeServices implements RememberMeServices,
	...
	/**
	 * 模板实现，它定位Spring安全cookie，将其解码为令牌的分隔数组，并通过processAutoLoginCookie方法
	...
	/**
	 * 在请求中定位Spring Security remember me cookie并返回其值。通过名称以及将上下文路径与cookie路径匹配来搜索cookie。
	...
	/**
	 * 从autoLogin调用以处理提交的持久登录cookie。子类应该验证cookie并执行所需的任何附加管理。
