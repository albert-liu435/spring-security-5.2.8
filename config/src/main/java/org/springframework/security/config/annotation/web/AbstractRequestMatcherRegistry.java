...
public abstract class AbstractRequestMatcherRegistry<C> {
	...
	/**
	 * 将{@link RequestMatcher}实例列表与{@link AbstractConfigAttributeRequestMatcherRegistry}关联
	...
	/**
	 * 子类应该实现这个方法来返回链接到{@linkrequestmatcher}实例创建的对象。
	...
	private static final class RequestMatchers {
		...
		/**
		 * 创建AntPathRequestMatcher的list实例
		...
		/**
		 * 创建AntPathRequestMatcher的list，不指定HttpMethod
